...
class TestAdvancedOperations:
    """Testing power and square root operations"""
    ...
    def test_sqaure_root_negative_raises_error(self):
        """Test that square root of negative number raises error"""
        with pytest.raises(ValueError, match="Cannot calculate square root of negative numbers"):
            square_root(-4)